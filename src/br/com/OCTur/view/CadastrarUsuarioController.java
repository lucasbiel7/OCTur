...
public class CadastrarUsuarioController implements Initializable {
    ...
    private void btCadastrarActionEvent(ActionEvent actionEvent) {
        ...
        Message.show("", ControlTranducao.traduzirPalavra("EVPESSOAADICIONADA"), Alert.AlertType.INFORMATION);
    ...
    public void validarCadastrar() {
        ...
        boolean usuarioValido = tfUsuario.getText().matches("^((\\w|\\.|@|-){1,})$") && new PessoaDAO().pegarPorUsuario(tfUsuario.getText()) == null;
